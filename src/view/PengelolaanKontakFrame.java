...
if (contacts.isEmpty()) {
JOptionPane.showMessageDialog(this, "Tidak ada kontak
ditemukan.");
}
} catch (SQLException ex) {
...
this,
"Apakah Anda yakin file CSV yang dipilih sudah sesuai dengan
format?",
...
JOptionPane.showMessageDialog(this, "Format header
CSV tidak valid. Pastikan header adalah: ID,Nama,Nomor Telepon,Kategori",
...
StringBuilder errorLog = new StringBuilder("Baris dengan
kesalahan:\n");
...
errorCount++;
errorLog.append("Baris ").append(rowCount +
1).append(": Gagal menyimpan ke database -
...
JOptionPane.showMessageDialog(this, guideMessage, "Panduan Format
